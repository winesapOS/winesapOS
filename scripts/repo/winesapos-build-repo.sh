...
cd mesa-git
### This dependency needs to be installed first.
makepkg -s --noconfirm -i
cp ./*.pkg.tar.zst ${OUTPUT_DIR}
## Mesa 32-bit.
sudo pacman -U --noconfirm /output/mesa-git-22.2.0_devel.156758.af2e4a23c99b.d41d8cd98f00b204e9800998ecf8427e-1-x86_64.pkg.tar.zst
cd ${WORK_DIR}
